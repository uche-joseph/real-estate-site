...
const listingId = getQueryParameter('id');
...
if (listing) {
    document.getElementById('listingName').textContent = listing.name;
    document.getElementById('listingType').textContent = listing.type;
    document.getElementById('listingPrice').textContent = listing.price.toLocaleString(); // Formats the number with commas
    document.getElementById('listingLocation').textContent = listing.location;
    document.getElementById('listingImage').src = listing.img;
} else {
