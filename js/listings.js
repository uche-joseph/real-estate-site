...
function displayListings(filteredListings) {
    ...
    filteredListings.forEach(listing => {
        ...
        listingElement.innerHTML = `
            ...
            <div class="property-name">${listing.name}</div>
            <div class="property-info">${listing.type}</div>
            <div class="property-price">${listing.price.toLocaleString()}</div>
            <div class="property-loc">${listing.location}</div>
            <a href="#" class="property-btn" onclick="window.location.href='details.html?id=${listing.id}'">View Details</button>
        `;
...
function applyFilters() {
    ...
    if (price) {
        filteredListings = filteredListings.filter(listing => listing.price <= parseInt(price));
    }
